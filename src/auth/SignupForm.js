...
function SignUpForm({onInputChange, onSubmitHandler, onEmailError, onPasswordError, onNameError}) {
  return (
    <>
        ...
        <div className="flex flex-col pt-4">
                <div className="flex relative ">
                    ...
                    <i className='fas fa-user mr-2 text-sm text-black'></i>
                    </span>
                    <input type="text" id="design-login-name" className=" flex appearance-none border border-gray-300 w-full py-2 px-4 bg-white text-gray-700 placeholder-gray-400 shadow-sm text-base focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent" name="name" placeholder="Name" onChange={onInputChange}/>
                </div>
            ...
            <div className="flex flex-col pt-4 mb-12">
                ...
                <input type="password" id="design-login-password2" className=" flex-1 appearance-none border border-gray-300 w-full py-2 px-4 bg-white text-gray-700 placeholder-gray-400 shadow-sm text-base focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent" placeholder="Password" name="confirmpassword" onChange={onInputChange}/>
                </div>
                <div className="mt-2 py-2 px-4 text-red-600 rounded-sm">
                    {onPasswordError}
                </div>
